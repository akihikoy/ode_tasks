...
*/
//-------------------------------------------------------------------------------------------
#ifndef arm7_door_push_h
#define arm7_door_push_h
//-------------------------------------------------------------------------------------------
#include <ode/ode.h>
...
extern bool Running;
extern void (*SensingCallback)(const TSensors2 &sensors);
...
//===========================================================================================
{
  ...
  std::vector<double> LinkX;  // Poses (x,y,z,qx,qy,qz,qw) of links; [7]*(12+JointNum+1)
  ...
  void SetZeros(int num_joints)
    {
      if(num_joints>=0)
      {
        ...
        LinkX.resize(7*(12+num_joints+1));
